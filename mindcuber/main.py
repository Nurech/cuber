...
def run_nw(mot, pos, speed):
    mot.run_to_position(pos, speed=speed, max_power=speed, stall=False, acceleration=100, deceleration=100,
                        stop=mot.STOP_HOLD)
...
def ScanPiece(spos, tpos, f, o, i, back=False):
    ...
    ScanRGB(f, o)
    print('SCANNING', f, o, sensor_color.get(), c.colors.get_clr(f, o))
