#MINDCUBERRI_FILES_V1P0#
#-----------------------------------------------------------------------------
# Title:        MindCuber-RI Solver Files
#
# Author:       David Gilday
#
...
#
#-----------------------------------------------------------------------------
# Purpose:      Main program files for MindCuber-RI robot Rubik's Cube solver
#-----------------------------------------------------------------------------

# See http:/mindcuber.com/mindcuberri/mindcuberri.html for details

# The following lines will be treated as data and installed on the hub
# Do not modify
#FILE/mcricolors_v1p0.py
#-----------------------------------------------------------------------------
# Title:        MindCuber-RI Colors
#
# Author:       David Gilday
#
# Copyright:    (C) 2021 David Gilday
...
# END
#ENDFILE
#FILE/mcrimaps_v1p0.py
#-----------------------------------------------------------------------------
# Title:        MindCuber-RI Maps
#
# Author:       David Gilday
#
# Copyright:    (C) 2021 David Gilday
...
# END
#ENDFILE
#FILE/mcrisolver_v1p0.py
#-----------------------------------------------------------------------------
# Title:        MindCuber-RI Solver
#
# Author:       David Gilday
#
# Copyright:    (C) 2021 David Gilday
...
try:
    large = os.stat("/mcrimtab4_v1p0.bin")[6] == 2561877
except:
    None
...
#    def display_line(self, f, l):
#        if (l == 0):
#            s = display_three(f, 2, 3, 4)
#        elif (l == 1):
#            s = display_three(f, 1, 8, 5)
#        else:
#            s = display_three(f, 0, 7, 6)
#        return s
#
#    def display(self):
#        for l in range(3):
...
def init(colors_module, map_module):
    trace("init()")
    global colors, cm, sm, mt
    colors = colors_module
    cm     = map_module.cube_map()
    sm     = solve_map()
    mt     = []
